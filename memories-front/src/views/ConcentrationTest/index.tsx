...
export default function ConcentrationTest() {
    ...
    // state: 집중력 검사 결과 상태 //
    const { measurementScore, errorCount, increaseMeasurementScore, increaseErrorCount, init, reset } =
            ...
            <div className="container">
                ...
                <div className="test-box">
                    {isStarted ? (
                        ...
                        <div className="button primary middle" onClick={onStartClickHandler}>
                            검사 시작
                        </div>
                    )}
                </div>
