...
function CommentItem({ commentItem }: CommentItemProps) {
    ...
    // variable: 작성 시간 문자열 //
    const writeDateText =
        diffWriteDate < SECOND_LIMIT
            ? diffWriteDate + ' 초'
            : diffWriteDate < MINUTE_LIMIT
            ? Math.floor(diffWriteDate / SECOND_LIMIT) + ' 분'
            : diffWriteDate < HOUR_LIMIT
            ? Math.floor(diffWriteDate / MINUTE_LIMIT) + ' 시간'
                ...
                <div className="contents-container">
                    ...
                    <div className="sub-container">
                        ...
                        <div className="footer">
                            ...
                            <div className="button second stratch" onClick={onPostCommentClickHandler}>
                                작성
                            </div>
                        </div>
                    </div>
