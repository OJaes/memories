        ...
        <div className="user-update-container">
            ...
            <div className="check-box">
                ...
                <div className="check-item-box">
                    <div className={manClass} onClick={() => onGenderChangeHandler('man')}>
                        남성
                    </div>
                    <div className={womanClass} onClick={() => onGenderChangeHandler('woman')}>
                        여성
                    </div>
                </div>
            </div>
            ...
            <div className="button primary fullwidth" onClick={onUpdateButtonClick}>
                수정
            </div>
        </div>
    );
...
export default function UserInfo() {
    ...
    return (
        <div className="user-info-container">
            ...
            <div className="button second middle" onClick={onUpdateOpenButtonClickHandler}>
                수정
            </div>
            {isUpdateOpen && (
                <Modal title="회원 정보 수정" onClose={onUpdateOpenButtonClickHandler}>
