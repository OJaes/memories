...
function MenuBar({ editor }: MenuBarProp) {
    ...
    return (
        <div id="text-editor-menu-bar">
            ...
            <div className="item-box">
                <div
                    className={`item ${editor.isActive('italic') ? 'active' : ''} italics`}
                    onClick={() => editor.chain().focus().toggleItalic().run()}
                ></div>
            </div>
            <div className="item-box">
                <div
                    className={`item ${editor.isActive('strike') ? 'active' : ''} strike`}
            ...
            <div className="item-box">
                <div
                    className={`item ${editor.isActive('heading', { level: 1 }) ? 'active' : ''} h1`}
                    onClick={() => editor.chain().focus().toggleHeading({ level: 1 }).run()}
                ></div>
            </div>
            <div className="item-box">
                <div
                    className={`item ${editor.isActive('heading', { level: 2 }) ? 'active' : ''} h2`}
                    onClick={() => editor.chain().focus().toggleHeading({ level: 2 }).run()}
                ></div>
            </div>
            <div className="item-box">
                <div
                    className={`item ${editor.isActive('heading', { level: 3 }) ? 'active' : ''} h3`}
            ...
            <div className="item-box">
                <div
                    className={`item ${editor.isActive('orderedList') ? 'active' : ''} ol`}
                    onClick={() => editor.chain().focus().toggleOrderedList().run()}
                ></div>
            </div>
            <div className="item-box">
                <div
                    className={`item ${editor.isActive('bulletList') ? 'active' : ''} ul`}
